...
class Map:
    def __init__(self, filepath: str):
        ...
        self.car_obj = OBJ('models/low/untitled.obj')
    ...
    def load_textures(self):
        ...
        self.textures[WATER_TEXTURE_PATH] = Texture2D(WATER_TEXTURE_PATH, wrap=GL_REPEAT)
        ...
        self.textures[GROUND_TEXTURE_PATH] = Texture2D(GROUND_TEXTURE_PATH)
    ...
    def load_polygon(self, properties: dict, coords: list[Vec2]):
        ...
        if properties.get('landuse') in (
            ...
            texture_size = self.km_to_world(0.005)
            height = self.km_to_world(0.001) * float(properties.get('height', '3'))
            color = BUILDING_COLOR

        else:
            texture = self.textures[GROUND_TEXTURE_PATH]
            
            texture_size = self.km_to_world(0.01)
            height = 0.00045
            color = UNKNOWN_COLOR

        self.polygons.append(Polygon(self, coords, height, color, texture, texture_size))
